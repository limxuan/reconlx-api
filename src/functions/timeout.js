...
async function timeout(message, msgToDelete, time = 10000) {
    ...
    if(!message.guild.me.permissions.has(Permissions.FLAGS.MANAGE_MESSAGES)) return console.log(`reconlx err: Discord Client need "MANAGE_MESSAGES" to work properly.`)
    msgToDelete.react('🗑')
